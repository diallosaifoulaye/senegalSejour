                            ...
                            <div class="col-lg-12">
                                <h3 class="panel-title pull-right">
                                    ...
                                    <button type="button" class="open-modal btn btn-success"
                                            data-modal-controller="cadeau/cadeauModal"
                                            data-modal-view="cadeau/cadeauModal">
                                        <i class="fa fa-plus"></i> <?php echo $this->lang['btnAjouterCadeau']; ?>
                                    </button>
                                </h3>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table table-bordered table-hover table-responsive processing"
                                       data-url="<?= WEBROOT; ?>cadeau/listeProcessingCadeau">
                                    <thead>
                                    <tr>
                                        <th><?php echo $this->lang['labNbrPoint']; ?></th>
                                        <th><?php echo $this->lang['labCadeau']; ?></th>
