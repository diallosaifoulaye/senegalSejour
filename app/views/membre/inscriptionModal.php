        ...
        <div class="white-box">
            ...
            <form class="form-horizontal form-material" id="loginform" action="<?php echo WEBROOT; ?>home/login" method="post">
                ...
                <div class="form-group m-t-40">
                    <div class="col-xs-12">
                        <input class="form-control" id="login" required name="login" type="text" placeholder="<?php echo $this->lang['nom'];?>">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control" id="password" required name="password" type="password" placeholder="<?php echo $this->lang['prenom'];?>">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control" id="password" required name="password" type="password" placeholder="<?php echo $this->lang['email'];?>">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
                        <input class="form-control" id="password" required name="password" type="password" placeholder="<?php echo $this->lang['telephone'];?>">
                    </div>
                </div>
                ...
                <div class="form-group text-center m-t-20">
                    <div class="col-xs-12">
                        <button  class="btn btn-lg btn-primary btn-block btn-signin" style="background: #1f3b72; border: 1px solid #137648" type="submit" ><span id="bc"><?php echo strtoupper($this->lang['s_inscrire']); ?></span></button>
                    </div>
                </div>
            </form>
        </div>
