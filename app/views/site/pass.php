                            ...
                            <div class="card mb-5 mb-lg-0">
                                <div class="card-body">
                                    ...
                                    if (intval($this->_USER->type_profil) == 3) {
                                        if ($AllReadySusbcribe != '0'){ ?>
                                            <button class="btn btn-block btn-primary text-uppercase" disabled >UN ABONNEMENT EN COURS</button>
                                        <?php }
                                        else { ?>
                                            <button class="open-modal  btn btn-block btn-primary text-uppercase" data-modal-controller="membre/souscriptionModal" data-modal-view="membre/souscriptionModal" data-modal-param ="<?php echo base64_encode($val["formules"]->id); ?>">Sélectionner</button>
                                        <?php }
                                    } else{ ?>
