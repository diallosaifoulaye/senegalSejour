<table class="table_full editable-bg-color bg_color_e6e6e6 editable-bg-image" bgcolor="#ebf8f" width="100%"
    ...
    <tr>
        <td>
            <table class="table1 editable-bg-color bg_color_303f9f" width="600" align="center" border="0"
                   cellspacing="0" cellpadding="0" style="margin: 0 auto; background: url(<?= HOST . ASSETS ?>plugins/images/meczy.png); background-repeat: no-repeat; background-position: center; background-color: #ffffff;">
                <tr>
                    <td height="25"></td>
                </tr>
                <tr>
