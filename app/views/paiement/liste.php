        ...
        <div class="container-fluid">
            ...
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title"><?php echo $this->lang['liste_paiement']; ?></h4> </div>
                            ...
                            <div class="col-lg-12">
                                <h3 class="panel-title pull-right">
                                    ...
                                    <button type="button" class="open-modal btn btn-success"
                                            data-modal-controller="paiement/paiementModal"
                                            data-modal-view="paiement/paiementModal">
                                        <i class="fa fa-plus"></i> <?php echo $this->lang['btnAjouterPaiement']; ?>
                                    </button>
                                </h3>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table table-bordered table-hover table-responsive processing"
                                       data-url="<?= WEBROOT; ?>paiement/listeProcessingPaiement">
                                    <thead>
                                    <tr>
                                        <th><?php echo $this->lang['liste_modes_paiement']; ?></th>
